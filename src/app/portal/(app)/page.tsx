  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Link href="/portal/tuition">
          <Card accent="accounting" className="h-full transition-shadow hover:shadow-md">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
