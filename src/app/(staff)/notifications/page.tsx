...
import type { NotificationLog, NotificationSummary } from "@/lib/api/types";
...
export default function NotificationsPage() {
  ...
  const { data, meta, isLoading } = usePaginatedResource(fetcher, [debouncedSearch, type, channel, status, page, perPage]);
